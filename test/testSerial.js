    ...
    it('Test Reading Serial', function (done) {
            ...
            socket.on('data', function (data) {
                ...
                if (hexData.substring(0,4) === '1040') {
                    ...
                    sendMessage(socket, sendBuf);
                         ...
                         hexData.substring(0, 23) === '680b0b6873fd52ffffff17f' ||
                         hexData.substring(0, 24) === '680b0b6873fd52ffffff18f') {
        ...
        server.on('listening', function() {
            ...
            if (!(process.env.APPVEYOR && process.env.APPVEYOR==='True')) {
                ...
                socat = spawn('C:\\cygwin\\bin\\socat.exe', ['-Dxs', 'pty,link=\\\\C\\SER1,ispeed=9600,ospeed=9600,raw', 'tcp:127.0.0.1:15001']);
            }
